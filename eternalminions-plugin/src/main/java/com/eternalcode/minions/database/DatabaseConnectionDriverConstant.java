...
final class DatabaseConnectionDriverConstant {
    ...
    // h2 — no leading "./": with an absolute Windows dataFolder (e.g. "C:/..."), H2's own path
    // parser rejects "./C:/..." as an invalid path, so the prefix must be dropped for both
    // relative and absolute folders to work.
