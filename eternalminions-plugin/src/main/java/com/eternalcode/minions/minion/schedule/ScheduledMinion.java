...
public final class ScheduledMinion {
    ...
    public ScheduledMinion(MinionId minionId) {
    ...
    public boolean isBusyUntil(long worldTime) {
        return this.hasBusyTimer() && worldTime < this.busyUntilWorldTime;
    }
    ...
    public long remainingBusyTicks(long worldTime) {
        ...
        return Math.max(0L, this.busyUntilWorldTime - worldTime);
    }
    ...
    public int miningTargetIndex(int targetCount) {
        ...
        return Math.floorMod(this.miningTargetIndex, targetCount);
    }
