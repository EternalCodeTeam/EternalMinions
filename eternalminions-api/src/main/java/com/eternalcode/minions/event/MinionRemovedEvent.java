...
/** Fired after a minion has been removed from runtime and queued for deletion. */
public final class MinionRemovedEvent extends MinionEvent {

    private static final HandlerList HANDLERS = new HandlerList();
    private final MinionSnapshot minion;

    public MinionRemovedEvent(
